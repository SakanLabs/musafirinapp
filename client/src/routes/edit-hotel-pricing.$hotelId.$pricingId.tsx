      ...
      <form onSubmit={handleSubmit} className="max-w-3xl mx-auto space-y-4">
        ...
        <div className="border border-[#e5e7eb] rounded-xl bg-white shadow-none overflow-hidden">
          <div className="px-6 py-4 border-b border-[#e5e7eb] flex items-center space-x-2">
            ...
            <h3 className="text-sm font-bold text-[#111111] uppercase tracking-wider">Room & Period</h3>
          </div>
          <div className="p-6 space-y-5">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                <label htmlFor="roomType" className={labelCls}>Room Type *</label>
                <Input
                  id="roomType"
              ...
              <div>
                <label htmlFor="mealPlan" className={labelCls}>Meal Plan *</label>
                <select
                  id="mealPlan"
